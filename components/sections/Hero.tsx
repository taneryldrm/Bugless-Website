    ...
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-black text-white">
            ...
            <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center">
                ...
                >
                    <span className="text-white">Markanız İçin</span> <br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-100 to-gray-500 whitespace-nowrap">
                ...
                >
                    Modern web tasarımı, e-ticaret siteleri, CRM sistemleri, özel yazılım geliştirme, sosyal medya yönetimi, SEO ve reklam yönetimi hizmetleriyle markanızı dijital dünyada bir adım öne taşıyoruz.
                </motion.p>
